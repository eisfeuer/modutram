describe("slot", function ()
    ...
    describe('getTypeFromId', function ()
        it("returns type from id", function ()
            assert.are.equal(t.TRAM_UP, Slot.getTypeFromId(Slot.makeId({type = t.TRAM_UP, gridX = 0, gridY = 0})))
            assert.are.equal(t.ASSET, Slot.getTypeFromId(Slot.makeId({type = t.ASSET, gridX = 0, gridY = 0, assetId = 3})))
            assert.are.equal(t.DECORATION, Slot.getTypeFromId(Slot.makeId({type = t.DECORATION, gridX = 0, gridY = 0, assetId = 3, decorationId = 3})))
        end)
    end)
end)