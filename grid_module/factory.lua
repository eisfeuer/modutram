...
local classes = {
    ...
    [t.BUS_UP_LEFT] = require("modutram.grid_module.BusUpLeft"),
    [t.BUS_UP_RIGHT] = require("modutram.grid_module.BusUpRight"),
    [t.BUS_DOWN_LEFT] = require("modutram.grid_module.BusDownLeft"),
    [t.BUS_DOWN_RIGHT] = require("modutram.grid_module.BusDownRight"),
